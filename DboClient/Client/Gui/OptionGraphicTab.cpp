...
RwBool COptionGraphic::Create( COptionWindowGui* pOptionWindow )
{
	...
	m_pStbResolutionTitle = (gui::CStaticBox*)GetComponent("stbResoulutionTitle");	///< Resolution settings
	m_pStbResolutionTitle->SetText( GetDisplayStringManager()->GetString( "DST_OPTION_GRAPHIC_RESOLUTION_TITLE" ) );
	m_pStbResolution = (gui::CStaticBox*)GetComponent("stbResoulution");		///< Resolution
	...
	m_pCbbResolution = (gui::CComboBox*)GetComponent("cbbGraphicResolution");		///< Resolution setting combo box
	...
	m_pStbGamma = (gui::CStaticBox*)GetComponent("stbGammaTitle");			///< Brightness
	...
	m_pScbGamma = (gui::CScrollBar*)GetComponent("scbGraphicGamma");		///< Brightness settings scrollbar
	...
	m_pBtnWindowMode = (gui::CButton*)GetComponent("btnWindowMode");		////< Toggle window mode
	...
	m_pStbEffectTitle = (gui::CStaticBox*)GetComponent("stbEffectTitle");		///< Effect title
	m_pStbEffectTitle->SetText( GetDisplayStringManager()->GetString( "DST_OPTION_GRAPHIC_TITLE" ) );
	m_pStbGraphicQuality = (gui::CStaticBox*)GetComponent("stbGrahpicQualityText");	///< Overall graphics quality
	...
	m_pStbGraphicQualityLow = (gui::CStaticBox*)GetComponent("stbGrahpicQualityLow");	///< low
	m_pStbGraphicQualityLow->SetText( GetDisplayStringManager()->GetString( "DST_OPTION_GRAPHIC_QUALITY_LOW" ) );
	m_pStbGraphicQualityMiddle = (gui::CStaticBox*)GetComponent("stbGrahpicQualityMiddle");	///< Norma
	m_pStbGraphicQualityMiddle->SetText( GetDisplayStringManager()->GetString( "DST_OPTION_GRAPHIC_QUALITY_MIDDLE" ) );
	m_pStbGraphicQualityHigh = (gui::CStaticBox*)GetComponent("stbGrahpicQualityHigh");	///< high
	m_pStbGraphicQualityHigh->SetText( GetDisplayStringManager()->GetString( "DST_OPTION_GRAPHIC_QUALITY_HIGH" ) );
	m_pStbGraphicQualityUser = (gui::CStaticBox*)GetComponent("stbGrahpicQualityUser");	///< User settings
	m_pStbGraphicQualityUser->SetText( GetDisplayStringManager()->GetString( "DST_OPTION_GRAPHIC_QUALITY_USER" ) );
	m_pScbGraphicQuality = (gui::CScrollBar*)GetComponent("scbGraphicQuality");		///< Graphic quality settings scrollbar
	...
	m_pStbTerrainDist = (gui::CStaticBox*)GetComponent("stbTerrainDist");		///< Terrain viewing distance
	...
	m_pScbTerrainDist = (gui::CScrollBar*)GetComponent("scbTerrainDist");		///< Terrain viewing distance setting scroll bar
	...
	m_pStbObjectDist = (gui::CStaticBox*)GetComponent("stbObjectDist");		///< Object viewing distance static box
	...
	m_pScbObjectDist = (gui::CScrollBar*)GetComponent("scbObjectDist");		///< Object viewing distance setting scroll bar
	...
	m_pBtnTerrainShadow = (gui::CButton*)GetComponent("btnTerrainShadow");	///< Terrain Shadows
	...
	m_pBtnWaterEffect = (gui::CButton*)GetComponent("btnWaterEffect");		///< water effect
	...
	//m_pStbCharacterDist = (gui::CStaticBox*)GetComponent("stbCharacterDist");	///< Character viewing distance
	//
	//// It is grayed out for disable processing.
	...
	//m_pScbCharacterDist = (gui::CScrollBar*)GetComponent("scbCharacterDist");	///< Character viewing distance setting scroll bar
	...
	//
    ////Disable the character's viewing distance.
	...
	m_pStbMagicEffect = (gui::CStaticBox*)GetComponent("stbMagicEffect");		///< Magic detailed effects
	...
	m_pScbMagicEffect = (gui::CScrollBar*)GetComponent("scbMagicEffect");		///< Magic detailed effect settings scroll bar
	...
	m_pStbWeatherEffect = (gui::CStaticBox*)GetComponent("stbWeatherEffect");	///< Weather effects
	...
	m_pScbWeatherEffect = (gui::CScrollBar*)GetComponent("scbWeatherEffect");	///< Weather effect settings scroll bar
	...
	m_pStbTextureQuality = (gui::CStaticBox*)GetComponent("stbTextureQuality");	///< Texture resolution
	...
	m_pScbTextureQuality = (gui::CScrollBar*)GetComponent("scbTextureQuality");	///< Texture resolution setting scroll bar
	...
	m_pStbCharacterEffectTitle = (gui::CStaticBox*)GetComponent("stbCharacterEffectTitle");	///< Character effect title
	m_pStbCharacterEffectTitle->SetText( GetDisplayStringManager()->GetString( "DST_OPTION_GRAPHIC_CHARACTER_EFFECT" ) );
	m_pBtnCartoonEdge = (gui::CButton*)GetComponent("btnCartoonEdge");			///< Cartoon outline
	...
	//m_pBtnUpgradeEffect = (gui::CButton*)GetComponent("btnUpgradeEffect");		///< Upgrade effect
	...
	m_pBtnHdrEffect = (gui::CButton*)GetComponent("btnHdrEffect");			///< HDR effect
...
void COptionGraphic::OnInit()
{
	...
	// Disable use if it is not FullScreen.
    ...
    // Set it to a temporary value for a while.
...
{
	// Because Offset is a number, an Offset is given equal to the size of the Dialog.

...
class CScrambleNotifyGui : public CNtlPLGui, public RWS::CEventHandler
{
	...
	struct sREWARD_WIDGET
	{
		...
		gui::CStaticBox*			pDojoNameStatic;				///< °ÆOwnership stamp°Ø
		gui::CStaticBox*			pRewardReputationPointStatic;	///< °ÆYupa Point°Ø
		gui::CStaticBox*			pRewardItemStatic;				///< °ÆAcquired items°Ø

	...
	NTL_SPROFILE("CNtlPLWater::OnRender")
		...
		else
		{
			...
			if(pNtlWorldSector->m_pWater->_pDepthMap)
			{
				...
				RwD3D9SetTextureStageState(3, D3DTSS_ALPHAOP, D3DTOP_SELECTARG1); // Determined in CNtlPLWater::OnRender
			...
			else
			{
				...
				RwD3D9SetTextureStageState(3, D3DTSS_ALPHAOP, D3DTOP_SELECTARG2); // Determined in CNtlPLWater::OnRender

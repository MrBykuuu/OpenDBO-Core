...
//I tried to inherit CSpawnParty, but since the constructor uses Singleton, I have to create it separately.
//I'll look into merging methods later when I have time.

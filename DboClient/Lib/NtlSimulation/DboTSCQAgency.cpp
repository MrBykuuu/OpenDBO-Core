...
{
	OUT_QMSG_0( "[Quest] 涅胶飘 肯丰 沥焊 贸府吝..." );
...
{
	OUT_QMSG_0( "[Quest] 涅胶飘 柳青 沥焊 贸府吝..." );
...
{
	OUT_QMSG_9( "[Quest] User -> GameServer : Confirm 贸府吝 [%d,%d,%d,%d,%d,%d,%d,%d,%d]", tId, tcCurId, tcNextId, uiParam[1], uiParam[2], uiParam[3], uiParam[4], byEventType, uiEventData );
...
{
	OUT_QMSG_3( "[Quest] GameServer -> User : Confirm 贸府吝 [%d,%d,%d]", tId, tcCurId, tcNextId );
...
{
	OUT_QMSG_1( "[Quest] User -> GameServer : Give up 贸府吝 [%d]", tId );
...
{
	OUT_QMSG_2( "[Quest] GameServer -> User : Give up 贸府吝 [%d, %d]", wResultCode, tId );
...
{
	OUT_QMSG_3( "[Quest] GameServer -> User : Server event start message 贸府吝 [%d, %d, %d]", tId, tcId, taId );
...
{
	OUT_QMSG_3( "[Quest] GameServer -> User : Server event end message 贸府吝 [%d, %d, %d]", tId, tcId, taId );
...
{
	OUT_QMSG_4( "[Quest] GameServer -> User : Server event update message 贸府吝 [%d, %d, %d, %d]", tId, tcId, taId, bySvrEvtType );
...
{
	OUT_QMSG_4( "[Quest] GameServer -> User : Update TS state message 贸府吝 [%d, %d, %d, %d]", tId, byType, wTSState, uiParam );
...
{
	OUT_QMSG_4( "[Quest] User -> GameServer : Update TS state message 贸府吝 [%d, %d, %d, %d]", tId, byType, wTSState, uiParam );
...
{
	OUT_QMSG_1( "[Quest] GameServer -> User : Update TS Event 贸府吝 [%d]", eID );
...
{
	OUT_QMSG_0( "[Quest] GameServer -> User : Remove TMQ Quest 贸府吝" );
...
{
	OUT_QMSG_3( "[Quest] Trigger -> User : Regist quest info nfy message 贸府吝 [%d, %d, %d]", tId, tcId, taId );
...
{
	OUT_QMSG_1( "[Quest] Trigger -> User : Unregist quest info nfy message 贸府吝 [%d]", tId );
...
{
	OUT_QMSG_1( "[Quest] Trigger -> User : Show quest window nfy message 贸府吝 [%d]", tId );
...
{
	OUT_QMSG_1( "[Quest] Trigger -> User : Show quest indicator nfy message 贸府吝 [%d]", tId );
...
{
	OUT_QMSG_3( "[Quest] Trigger -> User : Update quest state nfy message 贸府吝 [%d, %d, %d]", tId, uiUpdatedQState, uiQState );
	CDboTSCQCtrl* pQCtrl = (CDboTSCQCtrl*)FindProgressTrigger(tId);
...
{
	OUT_QMSG_3( "[Quest] Trigger -> User : Update quest progress info nfy message 贸府吝 [%d, %d, %d]", tId, eEvtInfoType, uiTimeLimit );
...
{
	OUT_QMSG_3( "[Quest] Trigger -> User : Accept proposal quest nfy message 贸府吝 [%d, %d, %d]", tId, tgId, tcId );
...
{
	OUT_QMSG_3( "[Quest] Trigger -> User : Accept reward nfy message 贸府吝 [%d, %d, %d]", tId, tgId, tcId );
...
{
	OUT_QMSG_2( "[Quest] Trigger -> User : Accept give up nfy message 贸府吝 [%d, %d]", tId, tgId );
...
{
	OUT_QMSG_3( "[Quest] User -> Trigger : Do quest message 贸府吝 [%d, %d, %d]", sQuestInfo.sKey.tID, eEvtGenType, uiOwnerId );
...
{
	OUT_QMSG_1( "[Quest] Trigger -> User : Show proposal dialog message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_2( "[Quest] User -> Trigger : Show proposal dialog message 贸府吝 [%d, %d]", sKey.tID, bAccept );
...
{
	OUT_QMSG_1( "[Quest] Trigger -> User : Show reward dialog message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_3( "[Quest] User -> Trigger : Show reward dialog message 贸府吝 [%d, %d, %d]", sKey.tID, nSelIdx, bCancel );
...
{
	OUT_QMSG_1( "[Quest] Trigger -> User : Show user selection dialog message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_3( "[Quest] User -> Trigger : Show user selection dialog message 贸府吝 [%d, %d, %d]", sKey.tID, tcSelId, bCancel );
...
{
	OUT_QMSG_1( "[Quest] Trigger -> User : Show narration dialog message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_2( "[Quest] User -> Trigger : Show narration dialog message 贸府吝 [%d, %d]", sKey.tID, bCancel );
...
{
	OUT_QMSG_1( "[Quest] Trigger -> User : Show unified narration dialog message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_2( "[Quest] User -> Trigger : Show unified narration dialog message 贸府吝 [%d, %d]", sKey.tID, bCancel );
...
{
	OUT_QMSG_1( "[Quest] Trigger -> User : Show server event message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Quest] User -> Trigger : Show server event message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Quest] Trigger -> User : Show npc conversation message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Quest] User -> Trigger : Show npc conversation message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Quest] Trigger -> User : Register quest info message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Quest] User -> Trigger : Register quest info message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Quest] Trigger -> User : Camera message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Quest] User -> Trigger : Camera message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Quest] Trigger -> User : Show object conversation message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Quest] User -> Trigger : Show object conversation message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Quest] Trigger -> User : Hint message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Quest] User -> Trigger : Hint message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Quest] Trigger -> User : Open window message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Quest] User -> Trigger : Open window message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Quest] User -> Trigger : PC conversation message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Quest] Trigger -> User : Teleport Mudosa message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Quest] User -> Trigger : Teleport Mudosa message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Quest] Trigger -> User : Register client timing message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Quest] User -> Trigger : Register client timing message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Quest] Trigger -> User : Execute client group message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Quest] User -> Trigger : Execute client group message 贸府吝 [%d]", sKey.tID );

...
{
	OUT_QMSG_6( "[Trigger] User -> GameServer : Confirm 贸府吝 [%d,%d,%d,%d,%d,%d]", tId, tcCurId, tcNextId, uiParam, byEventType, uiEventData );
...
{
	OUT_QMSG_3( "[Trigger] GameServer -> User : Confirm 贸府吝 [%d,%d,%d]", tId, tcCurId, tcNextId );
...
{
	OUT_QMSG_4( "[Trigger] GameServer -> User : Update TS state message 贸府吝 [%d, %d, %d, %d]", tId, byType, wTSState, uiParam );
...
{
	OUT_QMSG_4( "[Trigger] User -> GameServer : Update TS state message 贸府吝 [%d, %d, %d, %d]", tId, byType, wTSState, uiParam );
...
{
	OUT_QMSG_1( "[Trigger] GameServer -> User : Update TS Event 贸府吝 [%d]", eID );
...
{
	OUT_QMSG_3( "[Trigger] User -> Trigger : Do trigger message 贸府吝 [%d, %d, %d]", sQuestInfo.sKey.tID, eEvtGenType, uiOwnerId );
...
{
	OUT_QMSG_1( "[Trigger] Trigger -> User : Show proposal dialog message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_2( "[Trigger] User -> Trigger : Show proposal dialog message 贸府吝 [%d, %d]", sKey.tID, bAccept );
...
{
	OUT_QMSG_1( "[Trigger] Trigger -> User : Show reward dialog message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_3( "[Trigger] User -> Trigger : Show reward dialog message 贸府吝 [%d, %d, %d]", sKey.tID, nSelIdx, bCancel );
...
{
	OUT_QMSG_1( "[Trigger] Trigger -> User : Show user selection dialog message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_3( "[Trigger] User -> Trigger : Show user selection dialog message 贸府吝 [%d, %d, %d]", sKey.tID, tcSelId, bCancel );
...
{
	OUT_QMSG_1( "[Trigger] Trigger -> User : Show narration dialog message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_2( "[Trigger] User -> Trigger : Show narration dialog message 贸府吝 [%d, %d]", sKey.tID, bCancel );
...
{
	OUT_QMSG_1( "[Trigger] Trigger -> User : Show unified narration dialog message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_2( "[Trigger] User -> Trigger : Show unified narration dialog message 贸府吝 [%d, %d]", sKey.tID, bCancel );
...
{
	OUT_QMSG_1( "[Trigger] Trigger -> User : Show npc conversation message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Trigger] User -> Trigger : Show npc conversation message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Trigger] Trigger -> User : Camera message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Trigger] User -> Trigger : Camera message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Trigger] Trigger -> User : Show object conversation message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Trigger] User -> Trigger : Show object conversation message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Trigger] Trigger -> User : Hint message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Trigger] User -> Trigger : Hint message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Trigger] Trigger -> User : Open Window message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Trigger] User -> Trigger : Open Window message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Trigger] User -> Trigger : PC conversation message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Trigger] Trigger -> User : Teleport Mudosa message 贸府吝 [%d]", sKey.tID );
...
{
	OUT_QMSG_1( "[Trigger] User -> Trigger : Teleport Mudosa message 贸府吝 [%d]", sKey.tID );
